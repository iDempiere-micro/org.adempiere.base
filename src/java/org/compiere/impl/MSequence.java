...
public class MSequence extends X_AD_Sequence
{
	...
	static public void main (String[] args)
	{
		...
		/**	Lock Test **
		String trxName = "test";
		System.out.println(MSequence.getDocumentNo(115, trxName));
		System.out.println(MSequence.getDocumentNo(116, trxName));
		System.out.println(MSequence.getDocumentNo(117, trxName));
		System.out.println(MSequence.getDocumentNo(118, trxName));
		System.out.println(MSequence.getDocumentNo(118, trxName));
		System.out.println(MSequence.getDocumentNo(117, trxName));

		trxName = "test1";
		System.out.println(MSequence.getDocumentNo(115, trxName));	//	hangs here as supposed
		System.out.println(MSequence.getDocumentNo(116, trxName));
		System.out.println(MSequence.getDocumentNo(117, trxName));
		System.out.println(MSequence.getDocumentNo(118, trxName));
