...
public class MProductCategory extends X_M_Product_Category
{
	...
	/**	Categopry Cache				*/
	private static CCache<Integer,MProductCategory>	s_cache = new CCache<Integer,MProductCategory>(I_M_Product_Category.Table_Name, 20);
	/**	Product Cache				*/
	private static CCache<Integer,Integer> s_products = new CCache<Integer,Integer>(I_M_Product.Table_Name, I_M_Product_Category.Table_Name + ".M_Product", 100);
	/**	Static Logger	*/
