...
public class MSchedule extends X_AD_Schedule 
{
	...
	public static long getNextRunMS (long last, String scheduleType, String frequencyType, int frequency, String cronPattern)
	{
		...
		if (SCHEDULETYPE_Frequency.equals(scheduleType))
		{
			...
			else if (FREQUENCYTYPE_Minute.equals(frequencyType))
				typeSec = 60;
			else if (FREQUENCYTYPE_Hour.equals(frequencyType))
				typeSec = 3600;
			else if (FREQUENCYTYPE_Day.equals(frequencyType))
				typeSec = 86400;
		...
		else if (SCHEDULETYPE_CronSchedulingPattern.equals(scheduleType))
		{
